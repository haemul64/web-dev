...
function dirConsole(event) {
    console.dir(event.target);
}

btnRemove.addEventListener("click", dirConsole);
document
    .getElementById("btn-add-background")
    .addEventListener("click", dirConsole);
...
function changeBackgroundColorToBlue() {
    firstParagraph.classList.add("background-blue");
}

btnRemove.addEventListener("click", removeThirdParagraph);
btnAddBackground.addEventListener("click", changeBackgroundColorToBlue);
...
btnAddBackground.addEventListener("click", changeInlineStyles);
